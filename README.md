...
> Myst1cX's fork includes fixes for compatibility with the fork author's Spotify Web Lyrics+ userscript and ensures that the progress bar's appearance remains    
> consistent even with changes in Spotify's DOM structure.   
